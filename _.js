...
let _list = Buffer.from(fs.readFileSync("_.list", 'utf8'), "base64").toString('utf8')
...
fs.writeFile("_.list", Buffer.from(list, 'utf8').toString('base64'), function (err) {
  if (err) throw err
  console.log("_.list updated!")
})
